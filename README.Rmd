...
This work is licensed under a [Attribution-NonCommercial-ShareAlike 4.0 International License][by-nc-sa].
...
* The [shinyEventLogger](https://CRAN.R-project.org/package=shinyEventLogger) package
